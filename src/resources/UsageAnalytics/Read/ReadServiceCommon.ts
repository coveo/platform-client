export module ParamParts {
     ...
     */
    export interface EventDimensionsFilter {
        /**
     ...
     */
    export interface EventDimensionsExcludeFilter {
        /**
     ...
     */
    export interface EventDimensionsHideEventsFilter {
        /**
     ...
     */
    export interface EventMetricsInterval {
        /**
         * The metrics to fetch.
         */
        i?: string[];
     ...
     */
    export interface EventMetricsFilter {
        /**
     ...
     */
    export interface DeprecatedShortPaginated {
        /**
