...
export default class Filters extends ReadServiceResource implements ReadServiceHealthApi {
    ...
    getPermissionFilterUsers(filterId: string) {
        return this.api.get<PermissionsFilterUser[]>(
            this.buildPathWithOrg(`${Filters.permissionsBaseUrl}/${filterId}/users`),
        );
    }
    ...
    getPermissionFilterTargets(filterId: string) {
        return this.api.get<FilterTargetsResponse>(
            this.buildPathWithOrg(`${Filters.permissionsBaseUrl}/${filterId}/targets`),
        );
    }
