...
import {
    ProductListingReportingMetricsOptions,
    ProductListingReportingMetricsModel,
} from './ProductListingReportingMetricsInterfaces.js';

export default class ProductListingReportingMetrics extends Resource {
